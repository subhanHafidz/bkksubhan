  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      <div class="align-items-center d-none d-md-flex">
        ...
        <h3> SELAMAT DATANG DI WEBSITE KAMI {{ auth()->user()->name }}</h3>
      </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar  order-last order-lg-0 ">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#features">PERUSAHAAN</a></li>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(img/ypc.jpg)">
      
          
        </div>

        <!-- Slide 2 -->
        <div class="carousel-item" style="background-image: url(img/bkk.png)">
       
        </div>

        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(img/ypc1.jpg)">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-right">
            <img src="img/bkk.png" class="img-fluid" alt="">
          </div>
            ...
            <div class="container pt-4 px-1">
              ...
              <div class="col col-md-3 mb-3 textr-center">
                <div class="card h-100" style="width: 16rem;">
                  <img src="/storage/{{ $item->foto }}" class="card-img-top" alt="perusahaan">
                <div class="card-body text-center">
                  ...
                  <a href="/detail ">
                    <button class="btn btn-sm btn-primary" style="margin-left: 40px;margin-top: 40px;">&nbsp;<i class="fa fa-align-left" style="font-size: 20px;"></i>&nbsp;&nbsp; Detail</button>
                     </a>
                     <a href="/daftar">
                     <button class="btn btn-sm btn-success" style="margin-top: 40px;"><i class="fa fa-list-ol" style="font-size: 20px;"></i>&nbsp;&nbsp;Daftar</button> 
                      </a>
...
<section id="features" class="features">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Beberapa Kontak Yang Dapat Menghubungi Kami</p>
        </div>

      </div>

      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/place/SMK+YPC+Tasikmalaya/@-7.3608589,108.1032669,17z/data=!3m1!4b1!4m6!3m5!1s0x2e6f5523e04b2043:0x378ffcaddc4297c!8m2!3d-7.3608589!4d108.1058418!16s%2Fg%2F11h1m5g5tw?entry=ttu" frameborder="0" allowfullscreen></iframe>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Email Us</h3>
                  <p>SMKYPC@gmail.com<br>info@example.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#features">PERUSAHAAN</a></li>
